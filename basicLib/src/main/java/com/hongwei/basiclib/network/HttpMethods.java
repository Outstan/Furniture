package com.hongwei.basiclib.network;


import android.text.TextUtils;

import com.hongwei.basiclib.log.HttpLogger;
import com.hongwei.basiclib.log.LogUtil;
import com.hongwei.basiclib.ssl.HttpsUtils;
...
public class HttpMethods {
    ...
    public HttpMethods() {
        ...
        if (getInstanceBuilder().isUseDefaultSSLSocketFactory()) {
            ...
            if (getInstanceBuilder().getsSLSocketFactory() != null && getInstanceBuilder().getTrustManager() != null) {
